...
$result=$show->select_by_colname_reloaded('product',$cols,'sellerid',$seller_id);
?>
		...
		<div class="card">
			...
			<div class="card-footer">
				...
				<button type="button" class="btn btn-sm btn-outline-dark float-right" 
				 onclick="window.location.href='edit.php?product_id=<?php echo $row['id']+8887; ?>';">Edit</button>
			</div>
		</div>
	</div>
	<?php } ?>
